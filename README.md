...
| Component | Version |
|---|---|
| [Intel® Deep Learning Essentials](https://www.intel.com/content/www/us/en/developer/tools/oneapi/oneapi-toolkit-download.html?packages=dl-essentials&dl-essentials-os=linux&dl-lin=offline) (compiler, MKL, DPC++, CCL, TBB) | 2026.0.0 |
| [Intel® oneAPI Deep Neural Network Library (oneDNN)](https://www.intel.com/content/www/us/en/developer/tools/oneapi/onednn-download.html?operatingsystem=linux&distribution-linux=offline) | 2026.0.0 |
